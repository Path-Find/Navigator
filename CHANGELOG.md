...
- **CI Stability**: To resolve transient 429 Rate Limit errors during action downloads, migrated CodeQL from the unreliable 'Default' setup to an explicit, repository-controlled workflow file (`codeql.yml`).
