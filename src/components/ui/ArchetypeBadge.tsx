...
export const ArchetypeBadge: React.FC<ArchetypeBadgeProps> = ({ archetype }) => {
    ...
    const colorClasses: Record<string, string> = {
        indigo: 'bg-neutral-50 text-neutral-700 border-neutral-100 dark:bg-neutral-500/10 dark:text-neutral-400 dark:border-neutral-500/20',
        ...
        violet: 'bg-neutral-50 text-neutral-700 border-neutral-100 dark:bg-neutral-500/10 dark:text-neutral-400 dark:border-neutral-500/20',
