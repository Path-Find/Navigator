        ...
        <div className="mb-10 animate-in fade-in slide-in-from-top-4 duration-500">
            <div className="flex items-center gap-3 mb-4 px-1">
                ...
                <div className="flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-neutral-500/10 border border-neutral-500/20">
                    ...
                    <span className="text-neutral-600 dark:text-neutral-400 text-[10px] font-black tracking-tight">AI found {suggestions.length}</span>
                </div>
            </div>
            <div className="flex flex-wrap gap-2">
                {suggestions.map((skill, i) => (
                    <button
                        ...
                        className="group flex items-center gap-2.5 px-3.5 py-1.5 bg-neutral-50 dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-xl hover:border-neutral-500 hover:ring-1 hover:ring-neutral-500/30 transition-all shadow-sm group"
                    ...
                    >
                        ...
                        <Plus className="w-3.5 h-3.5 text-neutral-400 group-hover:text-neutral-600 transition-colors" />
                    </button>
                ))}
            </div>
        </div>
