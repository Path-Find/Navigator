...
export const Header: React.FC = () => {
    ...
    // Navigation Groups
    const navGroups: Array<{ id: string; label: string; icon: React.ElementType; isActive: boolean; defaultView: ViewId; items: Array<{ id: ViewId; label: string; icon: React.ElementType }> }> = [
        {
            id: 'job',
            label: 'Jobs',
            icon: Briefcase,
