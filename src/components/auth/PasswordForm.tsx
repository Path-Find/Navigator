        ...
        <form onSubmit={onSubmit} className="space-y-5 animate-in fade-in slide-in-from-right-4 duration-300">
                ...
                <div className="flex justify-between items-center mb-2 ml-1 mr-3">
                    ...
                    {!isSignUp && (
                        <button
                            ...
                            className="text-xs font-bold text-neutral-600 dark:text-neutral-400 hover:underline disabled:opacity-50"
                        >
            ...
            <div className="pt-2">
                <button
                    type="submit"
                    disabled={loading}
                    className="w-full bg-gradient-to-r from-neutral-600 to-neutral-600 hover:from-neutral-500 hover:to-neutral-500 text-white font-bold py-4 rounded-2xl shadow-lg shadow-neutral-500/25 transition-all flex items-center justify-center gap-2 disabled:opacity-70"
                >
