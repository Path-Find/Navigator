            ...
            <div className="card-premium p-10 shadow-2xl relative overflow-hidden">
                ...
                <motion.div
                    ...
                    className={`relative cursor-pointer border-3 border-dashed rounded-[2rem] p-12 mb-8 text-center transition-all duration-500 flex flex-col items-center justify-center overflow-hidden ${isDragging
                        ? 'border-neutral-500 bg-neutral-500/10 scale-[1.02] shadow-2xl shadow-neutral-500/20'
                        : 'border-neutral-100 dark:border-neutral-800 bg-neutral-50/50 dark:bg-neutral-900/30 hover:border-neutral-300 dark:hover:border-neutral-700'
                        }`}
                >
                    <input
                        ref={fileInputRef}
                        ...
                        className="hidden"
                    />
                    <div className="w-24 h-24 bg-white dark:bg-neutral-800 rounded-3xl shadow-xl flex items-center justify-center mb-6 ring-8 ring-neutral-500/5">
                        <Upload className="w-10 h-10 text-neutral-600 dark:text-neutral-400" />
                    </div>
                    ...
                    {isParsingResume && (
                        <div className="absolute inset-0 bg-white/80 dark:bg-neutral-900/80 backdrop-blur-sm flex flex-col items-center justify-center z-10">
                            <Loader2 className="w-10 h-10 text-neutral-600 animate-spin mb-4" />
