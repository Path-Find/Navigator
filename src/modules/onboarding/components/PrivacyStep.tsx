...
import { ArrowLeft, Check, Shield, Lock, Zap } from 'lucide-react';
            ...
            <div className="card-premium p-10 shadow-2xl relative overflow-hidden">
                ...
                <div className="space-y-3 mb-10">
                    {[
                        ...
                        { icon: <Zap className="w-5 h-5 text-amber-500" />, title: 'AI Processing', desc: 'We send your resume and job content to Google Gemini for analysis. It is not used to train Google\'s models, and logs are reviewed only when needed for support, quality, refunds, or abuse reports.', bg: 'bg-amber-500/5' },
