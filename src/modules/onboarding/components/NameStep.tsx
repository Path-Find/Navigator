...
export const NameStep = ({ applicationName, setApplicationName, setStep, handleNext }: any) => {
    return (
        <motion.div
            key="step-1.5"
        ...
        >
            <div className="card-premium p-10 shadow-2xl relative overflow-hidden">
                ...
                <div className="relative text-center mb-10">
                    ...
                    <p className="text-neutral-500 dark:text-neutral-400 text-lg font-medium">What name should appear on your applications?</p>
                </div>

                <div className="space-y-6 mb-10">
                    <div className="space-y-2">
                        <label className="text-xs font-black uppercase tracking-widest text-neutral-400 pl-1">Application name</label>
                        <input
                            type="text"
