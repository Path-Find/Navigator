...
export const JobFeedCard: React.FC<JobFeedCardProps> = ({ job, processingId, onAction, onSave }) => {
    return (
        <div className="bg-white dark:bg-neutral-900 rounded-[2.5rem] p-8 shadow-sm border border-neutral-200 dark:border-neutral-800 hover:shadow-xl hover:shadow-indigo-500/5 transition-all duration-300 group relative overflow-hidden">
            {job.isNew && (
