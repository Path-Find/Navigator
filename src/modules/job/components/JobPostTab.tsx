...
export const JobPostTab: React.FC<JobPostTabProps> = ({ job }) => {
    return (
        <div className="pb-8">
            <Card variant="premium" className="p-6 border-accent-primary/10 shadow-neutral-500/5">
                <h3 className="text-xs font-bold text-neutral-500 dark:text-neutral-400 mb-6">Job Description</h3>
