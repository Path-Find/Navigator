...
export const CoverLetterComparisonView: React.FC<CoverLetterComparisonViewProps> = ({
    ...
    return (
        <div className="flex flex-col h-full space-y-10">
            ...
            {versions.map((v, i) => (
                <div key={i} className="flex flex-col space-y-6 p-8 bg-neutral-50 dark:bg-neutral-800/50 rounded-3xl border-2 border-dashed border-neutral-200 dark:border-neutral-700 hover:border-neutral-300 dark:hover:border-neutral-500 transition-all group relative">
                    ...
                    <div className="pt-2">
                        <p className="text-xs font-bold text-neutral-600 dark:text-neutral-300">{v.styleDescription}</p>
                    </div>
                    ...
                    <button
                        ...
                        className="w-full py-3.5 bg-neutral-900 dark:bg-neutral-600 text-white rounded-2xl text-[10px] font-black hover:bg-neutral-800 dark:hover:bg-neutral-500 transition-all shadow-lg shadow-neutral-500/10 flex items-center justify-center gap-2 group-hover:scale-[1.02]"
                    >
