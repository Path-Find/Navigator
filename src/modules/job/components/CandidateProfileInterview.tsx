        ...
        return (
            <div className="min-h-screen bg-neutral-50 dark:bg-black px-4 py-16">
                <div className="max-w-xl mx-auto bg-white dark:bg-neutral-900 rounded-3xl border border-neutral-200 dark:border-neutral-800 p-8 text-center shadow-sm">
                    ...
                    <button onClick={close} className="rounded-2xl bg-indigo-600 text-white px-5 py-3 text-sm font-black">Back to interviews</button>
                </div>
            </div>
        );
    }
        ...
        return (
            <div className="min-h-screen bg-neutral-50 dark:bg-black px-4 py-16">
                <div className="max-w-2xl mx-auto">
                    <button onClick={close} className="inline-flex items-center gap-2 text-xs font-black text-neutral-500 hover:text-indigo-600 mb-8">
                    ...
                    <div className="bg-white dark:bg-neutral-900 rounded-3xl border border-neutral-200 dark:border-neutral-800 p-8 shadow-sm">
                        ...
                        {draft.signals.length > 0 && (
                            <section className="mb-6">
                                ...
                                <div className="space-y-2">
                                    {draft.signals.map((signal, index) => <p key={`${signal.key}-${index}`} className="text-sm text-neutral-700 dark:text-neutral-300 bg-indigo-50 dark:bg-indigo-500/10 rounded-xl px-4 py-3">{signal.value}</p>)}
                                </div>
                            </section>
                        )}
                        ...
                        {saved ? (
                            ...
                            <button onClick={() => { void handleSave(); }} className="w-full inline-flex items-center justify-center gap-2 rounded-2xl bg-indigo-600 hover:bg-indigo-700 text-white py-3 text-sm font-black"><Save className="w-4 h-4" /> Save to my profile</button>
                        )}
                    </div>
                </div>
            </div>
