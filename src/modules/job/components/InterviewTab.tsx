    ...
    return (
        <div className="pb-8 overflow-x-hidden">
            <section className="space-y-8">
                {userTier === 'free' ? (
                    <Card variant="premium" className="relative p-12 border-neutral-500/20 overflow-hidden group">
                        <div className="absolute inset-0 bg-white/40 dark:bg-neutral-900/40 backdrop-blur-md z-10 flex flex-col items-center justify-center p-8 text-center">
                            <div className="w-14 h-14 bg-neutral-600 rounded-2xl flex items-center justify-center text-white mb-5 shadow-lg shadow-neutral-500/30 group-hover:scale-105 transition-transform">
                            ...
                            <Button
                                ...
                                className="bg-neutral-600 hover:bg-neutral-700 text-white px-6 py-3 rounded-xl text-xs font-bold shadow-lg shadow-neutral-500/20"
