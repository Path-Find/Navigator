            ...
            <div className="bg-white dark:bg-neutral-900 rounded-3xl shadow-sm border border-neutral-200 dark:border-neutral-800 overflow-hidden">
                ...
                <div className="p-6 min-h-[600px] flex flex-col bg-white dark:bg-neutral-900 overflow-hidden">
                    {isGenerating ? (
                        ...
                        <div
                            className="flex-1 text-neutral-800 dark:text-neutral-200 leading-relaxed text-sm whitespace-pre-wrap selection:bg-indigo-100 dark:selection:bg-indigo-500/30 outline-none transition-colors border-none p-2 font-serif min-h-[500px]"
                            contentEditable
